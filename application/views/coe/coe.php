    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col">
            <a href="<?= base_url('super/coe_add_page'); ?>" class='btn btn-primary float-end icon'>
          ...
          <tbody>
            ...
            <?php foreach ($coe->result() as $prt) : ?>
              <tr>
                ...
                <td><?= $prt->program; ?></td>
                <td>
                  <a href="<?= base_url('super/coe_detail/') . $prt->id ?>"><span class="badge bg-success">Detail</span></a>
                  <a href="<?= base_url('super/coe_edit_page/') . $prt->id ?>"><span class="badge bg-warning">Edit</span></a>
                    ...
                    <div class="modal fade text-left" id="danger<?= $prt->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                          ...
                          <form class="form-horizontal" method="post" action="<?= base_url('super/coe_delete') ?>">
